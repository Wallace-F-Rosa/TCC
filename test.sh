...
if [[ $# -ge 3 ]]
then
    python ../../TCC/generate_code.py "../../redes_reg_genes/redes_bio/40-100/${1}/expr/expressions.ALL.txt" $3 --test-both
else
    python ../../TCC/generate_code.py "expressions_pesos.txt" --test-both
fi
